...
const Home = () => {
  return (
    <>
      ...
      <main className="flex flex-wrap justify-center items-center mt-20 h-screen overflow-auto">
        ...
        <div className="bg-verde-insted w-11/12 h-1/5 flex flex-col rounded-md mt-4">
          <div>
            ...
            <nav>
              <ul className="flex flex-wrap">
                ...
                <SubjectPost
                  ...
                  teacher="Ana Cláudia Pedro Ândreo"
                />
                <div className="bg-white w-full h-1/4 flex-wrap rounded-sm mx-1 grid grid-cols-3">
